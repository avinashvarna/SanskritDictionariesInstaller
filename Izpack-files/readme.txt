...
under the Sanskrit Dictionaries Start Menu item (if you choose to create a start 
menu item). The installer will also create Desktop shortcuts if that option is 
chosen during installation.

Hope you enjoy using the dictionaries converted to this easy to use format by 
the hard work of the sanskrit programmers volunteer group!
